...
<div id="hornav" class="row text-light">
    ...
    <div>
        <a href="receipt.php"  style="margin-left: 560px; font-size: larger" class="fa-paperclip">Purchase Generate Reciept</a><br><br>
        <a href="clearcart.php"  style="margin-left: 610px; font-size: larger" class="fa-shopping-cart">ClearCart</a><br><br>
    </div>
